    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                requests -> requests
                        ...
                        .mvcMatchers(HttpMethod.POST, "/songs/save").hasRole("ADMIN") //MvcMatcher -> AuthorityAuthorizationManager Żądania POST wysyłane pod adres /songs/save mogą wykonywać tylko użytkownicy z rolą USER, lub ADMIN
